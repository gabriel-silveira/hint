 ...
 *
 * Animations: staggered scroll-triggered fadeInUp via <ScrollReveal>. Each
 * content element has a progressive delay (0.1s → 0.6s) to guide the eye
 * down the column as the section enters the viewport.
 *
 * Accessibility:
          ...
          <div className="grid grid-cols-1 md:grid-cols-[40%_60%] md:items-stretch">
            ...
            <div className="order-1 px-5 pt-12 md:col-start-2 md:row-start-1 md:pt-24 md:pl-16 lg:pl-20">
              ...
              <ScrollReveal delay={0.1}>
                <p className="mb-5 self-start rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-white/70 md:border-hint-purple/20 md:bg-hint-purple/5 md:text-hint-purple inline-block">
                  QUEM ENSINA
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.2}>
                <h2 className="font-heading text-4xl font-bold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl md:text-foreground">
                  Sua professora
                </h2>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <p className="mt-3 max-w-lg text-lg font-normal leading-snug text-white/80 md:text-xl md:text-muted-foreground">
            ...
            <div className="order-3 px-5 pb-12 md:col-start-2 md:row-start-2 md:pb-24 md:pl-16 lg:pl-20">
              ...
              <ScrollReveal delay={0.4}>
                <blockquote className="rounded-r-xl border-l-4 border-hint-purple bg-white/10 px-5 py-4 md:bg-hint-purple/5">
