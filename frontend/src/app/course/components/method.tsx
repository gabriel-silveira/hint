      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-7 lg:gap-8">
          ...
          <ScrollReveal delay={0.3} className="h-full">
            <div className="flex h-full flex-col rounded-xl border border-border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
           ...
           */}
          <ScrollReveal delay={0.5} className="md:-mt-3 md:-mb-3 md:h-[calc(100%+1.5rem)]">
            <div className="relative flex h-full flex-col overflow-hidden rounded-xl p-6 shadow-[0_8px_40px_rgba(85,3,175,0.30)] ring-2 ring-hint-purple md:py-9"
